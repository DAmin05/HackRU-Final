...
def aimset():
    ...
    aim_data["Calories"] = request.form["Calories"]
    aim_data["Protien"] = request.form["Protein"]
    aim_data["Fats"] = request.form["Fats"]
    aim_data["Sugar"] = request.form["Sugar"]
    aim_data["Fiber"] = request.form["Fiber"]
    aim_data["Carbs"] = request.form["Carbs"]
    
    return render_template("Web.html", content = aim_data)


@app.route("/generate", methods=['GET', 'POST'])
def generate(progress, aim_data):
